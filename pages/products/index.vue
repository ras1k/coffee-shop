          ...
          <div class="bg-white border p-2 rounded-full drop-shadow-md">
            ...
            >
              ...
              >
                <h1
                  @click="allMenu()"
                  class="font-semibold h-full w-full px-1 py-1.5 bg-yellow-900 rounded-2xl flex items-center justify-center"
              ...
              >
                <p
                  class="font-semibold h-full w-full px-1 py-1.5 rounded-2xl flex items-center justify-center"
                  :class="
