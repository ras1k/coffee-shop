...
<template>
  <div class="pt-[80px] px-[10%] flex gap-5 pb-5">
    <div class="w-3/4">
      <div class="bg-white sticky top-[80px] z-10 py-5">
      ...
      <div v-else class="px-5">
        <div class="pb-2 border-b-2 border-b-gray-500 mb-2">
          <h1 class="text-3xl font-semibold">{{ selectedMenu.name }}</h1>
        </div>
        <div class="grid lg:grid-cols-3 2xl:grid-cols-4 gap-5">
      ...
      <div class="sticky top-[80px] z-10 py-5">
        ...
        <div class="bg-white rounded-xl drop-shadow-md p-3 mb-3">
          ...
          <div class="pb-2 flex items-center gap-2 text-sm font-semibold">
            ...
            <input
              type="text"
              placeholder="Enetr delivery address"
              class="py-1.5 pl-1"
            />
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl drop-shadow-md p-3 mb-3">
          ...
          <p class="text-center text-[#f19822] text-sm py-2">I have a coupon</p>
          <button
            class="w-full py-1.5 px-2 rounded-full bg-[#f19822] text-white font-semibold"
          >
            Go to checkout
          </button>
        </div>
