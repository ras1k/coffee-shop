  ...
  <div>
    <div class="py-6">
      <div class="flex justify-between items-center pt-4">
        <p class="text-2xl text-orange-400 font-bold pb-2">Select Bid</p>
      </div>
      <hr />
      <div class="grid grid-cols-1 gap-5 my-5">
        <div
          class="rounded-md px-2 py-3 flex gap-5 justify-between bg-gray-700 shadow-md items-center"
        >
            ...
            <tbody>
              <tr class="">
                ...
                <td class="py-4 p-2 flex items-center gap-2">
                  <img src="@/assets/img/avatar.webp" alt="" class="h-10" />
                ...
                <td class="py-4 p-2">
                  <select
                    name=""
                    id=""
                    class="text-black rounded-xl p-1 focus:outline-none"
                  >
                    <option value="">Select</option>
                    <option value="">Reject</option>
                    <option value="">Substitute 1</option>
                    <option value="">Substitute 2</option>
                  </select>
                </td>
                <td class="py-4 p-2">
                  <!-- <button
              ...
              <tr class="bg-gray-600">
                ...
                <td class="py-4 p-2 flex items-center gap-2">
                  <img src="@/assets/img/avatar.webp" alt="" class="h-10" />
                  <h3 class="font-bold">Vegetable</h3>
                </td>
