...
<template>
  <div class="container">
    <div class="py-6">
      ...
      >
        <p class="text-2xl text-[#6F4E37] font-bold pb-2">Brand List</p>
      </div>
      <hr />
      <div class="grid grid-cols-1 gap-5 my-5">
        <div
          class="rounded-md px-2 py-3 flex gap-5 justify-between bg-gray-700 text-white shadow-md items-center"
        >
          <table class="table-auto w-full">
            <thead>
              <tr class="bg-gray-600 text-xl">
                <th class="p-2 text-left">Brand Id</th>
                <th class="p-2 text-left">Brand Name</th>
                <th class="p-2 text-left">Details</th>
              </tr>
            </thead>
            <tbody v-for="brand in brands">
              <tr class="">
                <td class="py-4 p-2 gap-2">
                  <h3 class="font-bold">{{ brand.id }}</h3>
                </td>
