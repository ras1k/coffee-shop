...
// pinia
const { marketingPromo } = storeToRefs(useMarketingDashboardStore());

const { approvedMarketingPromo, deleteMarketingPromo } =
    ...
    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
      <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
          ...
          <tbody>
            <template v-for="singlePromo in marketingPromo">
              <tr v-if="!singlePromo.isApproved">
                ...
                >
                  <BaseButton
                    ...
                    @click="approvedMarketingPromo(singlePromo.id)"
                  />

                  <span
                    class="text-red-500 px-2 cursor-pointer"
                    @click="deleteMarketingPromo(singlePromo.id)"
                  >
                    <fa
